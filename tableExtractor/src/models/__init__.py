...
def load_model_from_path(model_path, device=None, attributes_to_return=None, eval_mode=True):
    ...
    model = get_model(checkpoint['model_name'])(checkpoint['n_classes_1'], checkpoint['n_classes_2'], checkpoint['n_classes_3'], checkpoint['n_classes_4'], **checkpoint['model_kwargs']).to(device)
